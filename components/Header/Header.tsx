          ...
          <nav className={styles.navLeft}>
            ...
            >
              ...
              {isDirectionsOpen && categories && categories.length > 0 && (
                <div className={styles.directionsMenu} onClick={() => setIsDirectionsOpen(false)}>
                    ...
                    >
                      ...
                      <div className={styles.directionContent}>
                        ...
                        <div className={styles.directionDesc}>
                          {category.description || `Коллекции: ${category._count?.collections || 0}`}
                        </div>
                      </div>
                    </Link>
                  ))}
            ...
            <div className={styles.profileContainer}>
              ...
              {isProfileMenuOpen && (
                <div className={styles.profileMenu}>
                  ...
                  <Link href="/admin" className={`${styles.profileMenuItem} ${styles.adminLink}`}>
                    🔧 Админ-панель
                  </Link>
