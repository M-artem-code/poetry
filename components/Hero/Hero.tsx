      ...
      <div className="container">
        <div className={styles.heroContent}>
          <h1 className={styles.title}>
            БЕЛАРУСКАЯ ПАЭЗІЯ<br/>
            ДЛЯ ДУШЫ І СЭРЦА
          </h1>
          
          <p className={styles.subtitle}>
            ВЕРШЫ АД ВЯЛІКІХ БЕЛАРУСКІХ ПАЭТАЎ ПАД ЛЮБЫ<br/>
        ...
        {/* Hero Image */}
        <div className={`${styles.imageContainer} ${imageLoaded ? styles.imageLoaded : ''}`}>
